...
>
> These samples are proofs of concept, preserved as-is. They are **not
> guaranteed to build or run against current versions of OpenUSD or its
> dependencies**, and we are not maintaining them against a moving toolchain.
...
>
> Build and dependency friction is an ecosystem-wide problem, not something
> specific to these samples. Work toward a portable, target-based OpenUSD cmake
> config is happening in the open at the [AOUSD Build Interest Group](https://github.com/aousd/build-ig-initiatives)
...
>
> Specific build problems people have reported — and the local workarounds for
> them — are written up in the issue tracker; they're there for reference, not as
> an open support channel.
